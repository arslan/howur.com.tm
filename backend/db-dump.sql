...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 340, true);
...
SELECT pg_catalog.setval('public.strapi_database_schema_id_seq', 72, true);
