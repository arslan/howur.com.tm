...
31	1	2	contacts.address	form_address	1
32	1	1	contacts.mail	form_mail	1
33	1	2	contacts.phone-number	form_number	1
\.
...
1	2022-06-20 14:45:20.084	2022-06-24 13:42:06.879	1	1	ru
\.
...
40	1	2	navbar-header.navbar	navbar	1
41	1	3	contacts.address	address	1
42	1	3	contacts.phone-number	number	1
43	1	1	footer.footer-main	footer	1
44	1	1	footer.footer-dev	footer_dev	1
\.
...
1	2022-06-20 12:06:20.758	2022-06-24 13:41:40.896	1	1	ru
\.
...
113	1	1	services.services	services	1
114	1	1	products.product	product	1
115	1	1	about.about	about	1
116	1	1	certificate.certificate	certificate	1
117	1	1	form.form-main	form	1
\.
...
6	Видеонаблюдение	2022-06-24 11:49:43.695	2022-06-24 11:50:12.624	1	1	ru	сonstruction-service
\.
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 219, true);
...
SELECT pg_catalog.setval('public.components_form_form_mains_components_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.layouts_components_id_seq', 44, true);
...
SELECT pg_catalog.setval('public.mains_components_id_seq', 117, true);
...
SELECT pg_catalog.setval('public.under_navs_id_seq', 6, true);
