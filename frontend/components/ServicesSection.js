        ...
        <div className="flex py-6">
          <div className="w-full text-right">
            ...
            <p className="w-1/2 ml-auto pt-12">
              ...
              foliage, a lurid communal mural that completely covered the hull
              of the Villa bespeak a turning in, a denial of the bright void
              beyond the hull. Images formed and reformed: a flickering montage
              of the Sprawl’s towers and ragged Fuller domes, dim fi
            </p>
          </div>
        </div>
